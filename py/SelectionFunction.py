...
class SelectionFunction:
    ...
    def set_fiducial_df_actions_Bovy_from_precalculated_actions(self,df_fid,
                                                            nrs,nzs,ngl_vel,n_sigma,vT_galpy_max,
        ...
        NAME:
            ...
            set_fiducial_df_actions_Bovy_from_precalculated_actions

        PURPOSE:

            This function sets actions that have been previously calculated
            with the function set_fiducial_df_actions_Bovy.
        ...
        HISTORY:
            ...
            2016-02-18 - Started (mostly copied from set_fiducial_df_actions_Bovy()). - Wilma Trick (MPIA)
        """
